...
training_data=test(featurevector,rows,cols,numlabels,reshapelabel,itr,Map_cell);
%training_data=test1(featurevector,rows,cols,numlabels,reshapelabel,itr,Map_cell);
